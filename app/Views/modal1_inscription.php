      ...
      <div class="modal-body">
        ...
        <ul class="nav nav-pills nav-fill mb-5" id="pills-tab" role="tablist">
            <li class="nav-item" role="presentation">
              <button class="nav-link active" id="pills-inscription-tab" data-bs-toggle="pill" data-bs-target="#pills-inscription" type="button" role="tab" aria-controls="pills-inscription" aria-selected="false">Inscription</button>
            </li>
          <li class="nav-item" role="presentation">
              <button class="nav-link" id="pills-connexion-tab" data-bs-toggle="pill" data-bs-target="#pills-connexion" type="button" role="tab" aria-controls="pills-connexion" aria-selected="true">Connexion</button>
          </li>
        ...
        <div class="tab-pane fade show active" id="pills-inscription" role="tabpanel" aria-labelledby="pills-inscription-tab">
          <form>
            <div class="mb-3 row">
              <div class="col">
          ...
          <div class="tab-pane fade " id="pills-connexion" role="tabpanel" aria-labelledby="pills-connexion-tab">
            <form>
              <div class="mb-3">
